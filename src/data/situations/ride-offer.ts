...
export const situation: Situation = {
  ...
  scripts: [
    {
      ...
      lines: [
        ...
        '"அல்லது "அம்மா / அப்பாவிடம் கேட்டுவிட்டு சொல்கிறேன்" என்று சொல்லி உடனே தொலைபேசியில் கேள்."',
  ...
  remember: [
    ...
    'குழந்தை வாகனத்தில் ஏறிவிட்டால் — உடனே இருப்பிடத்தை பகிரட்டும் (location share)',
  ],
  imagePrompt:
