...
export const assemblyParagraphs: ScriptParagraph[] = [
  ...
  {
    html: '<strong>விதி 5:</strong> CHILDLINE 1098 — இது ஒரு இலவச helpline. நீங்கள் எந்த ஆபத்திலும் இருந்தால் — பகலோ, இரவோ — இந்த எண்ணை அழையுங்கள்.',
  },
  {
  ...
  {
    html: '— Estimated reading time: 3–4 minutes at a measured pace.',
...
export const ptaParagraphs: ScriptParagraph[] = [
  ...
  { html: 'இன்று assembly-ல் குழந்தைகளுக்கு உடல் பாதுகாப்பு பற்றி கற்பித்தோம். இந்த 3 விஷயங்களை இன்றே வீட்டில் மீண்டும் பேசுங்கள்:' },
...
export const checklistItems: ChecklistItem[] = [
  ...
  {
    icon: '📋',
    ta: 'POCSO Section 19 கீழ் — சந்தேகம் வந்தால் புகார் செய்வேன்',
    en: 'I know my legal duty under POCSO Section 19 to report suspected abuse.',
  },
  {
    icon: '📞',
    ta: 'CHILDLINE 1098 எண் என் phone-ல் save செய்திருக்கிறேன்',
    en: 'I have CHILDLINE 1098 saved in my phone and know how to report.',
  },
  {
    icon: '👨‍👩‍👧',
    ta: 'PTA meeting-ல் பெற்றோரிடம் பாதுகாப்பு பற்றி பேசியிருக்கிறேன்',
