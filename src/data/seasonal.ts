...
export const seasonalBanners: SeasonalBanner[] = [
  {
    ...
    body: 'கோடை காலத்தில் குழந்தைகள் tuition, summer camp போவார்கள். புதிய இடங்களில் யார் யார் இருக்கிறார்கள் என்று கவனிங்கள். குழந்தை தனியாக இருக்கிறதா என்று உறுதி செய்யுங்கள்.',
  ...
  },
  {
    ...
    body: 'புதிய வகுப்பு, புதிய ஆசிரியர், புதிய நண்பர்கள். இந்த நேரத்தில் குழந்தையிடம் Good Touch / Bad Touch, 1098 — இவற்றை மீண்டும் நினைவுபடுத்துங்கள்.',
