...
export const scenarios: ScenarioData[] = [
  ...
  },
  {
    ...
    answer: 'ஓடாதே — நில். அருகில் இருக்கும் கடை ஆள் அல்லது பெண் பாதுகாப்பாளரிடம் போ. அம்மா அல்லது அப்பா பெயரும் phone number-உம் சொல். யாரோ \'நான் அழைத்துச் செல்கிறேன்\' சொன்னால் — வேண்டாம் என்று சொல், அங்கேயே நில், உதவிக்காக கத்து.',
    answerLabel: 'குழந்தை என்ன செய்ய வேண்டும்?',
  },
  {
    icon: '🤫',
