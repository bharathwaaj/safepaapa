...
export const safeClassroomTips: BilingualItem[] = [
  { ta: 'நல்ல தொடுதல் / கெட்ட தொடுதல் (Good Touch / Bad Touch) பாடம் ஆண்டுதோறும் கற்பியுங்கள்',   en: 'Teach body safety every year, not just once.' },
  ...
  { ta: 'பள்ளியின் பாதுகாப்பு பொறுப்பாளர் (Safeguarding Officer) யார் என்று தெரிந்துகொள்ளுங்கள்',       en: 'Know who the designated safeguarding officer is in your school.' },
  { ta: 'சக ஊழியரின் தவறான நடத்தையையும் புகார் செய்யுங்கள்',     en: 'Report inappropriate behaviour by a colleague, even when it feels uncomfortable.' },
];
...
export const studentDisclosureDos: DisclosureItem[] = [
  ...
  { do: true,  ta: 'உடனே தலைமை ஆசிரியர் / முதல்வரிடம் (Headmaster / Principal) தெரிவியுங்கள்',                    en: 'Inform the headmaster or principal immediately.' },
